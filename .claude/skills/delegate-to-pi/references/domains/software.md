...
## Workspace layout
A git repository and its tracked source, tests, and build artifacts constitute the deliverable. Use `using-git-worktrees` before work; never begin implementation on main/master without explicit consent, and preserve the linked worktree through review and final delivery.
